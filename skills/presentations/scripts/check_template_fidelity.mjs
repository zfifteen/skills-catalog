...
import { DEFAULT_SLIDE_SIZE, parseArgs, requireArg } from "./artifact_tool_utils.mjs";
...
const SCAN_EXTENSIONS = new Set([".mjs", ".js", ".cjs", ".ts", ".tsx", ".py", ".sh", ".txt", ".md", ".jsonl"]);
...
function usage() {
  return [
    "Usage:",
    "  node scripts/check_template_fidelity.mjs --workspace <dir> --final-pptx <deck.pptx> [options]",
    "",
    "Options:",
