...
INPUT
	•	TARGET_URL: <paste a GitHub Issues or Repo URL here, e.g., https://github.com/zfifteen/z-sandbox/issues>
	•	(Optional) GITHUB_TOKEN: set in environment if available for higher rate limits and private repos.

REFERENCE LINKS — RELEVANT GITHUB WORK (for context)
	•	Profile: https://github.com/zfifteen
	•	Core repos:
	•	z-sandbox — https://github.com/zfifteen/z-sandbox
	•	unified-framework — https://github.com/zfifteen/unified-framework
	•	dmc_rsa — https://github.com/zfifteen/dmc_rsa
	•	wave-crispr-signal — https://github.com/zfifteen/wave-crispr-signal
	•	dna-breathing-dynamics-encoding — https://github.com/zfifteen/dna-breathing-dynamics-encoding
	•	transect — https://github.com/zfifteen/transect
	•	z-amx — https://github.com/zfifteen/z-amx
	•	z_key_gen — https://github.com/zfifteen/z_key_gen
	•	z-open-cryptochat — https://github.com/zfifteen/z-open-cryptochat
	•	cognitive-number-theory — https://github.com/zfifteen/cognitive-number-theory
	•	ArctanGeodesic — https://github.com/zfifteen/ArctanGeodesic
	•	primecount-geodesic — https://github.com/zfifteen/primecount-geodesic
	•	z-opencode — https://github.com/zfifteen/z-opencode
	•	Pinned gists:
	•	Golden Ratio Prime Clustering — https://gist.github.com/zfifteen/9bdc891361f5f4606436c736d00af726
	•	Proof & Analysis of Relativistic Doppler Shift Bounds — https://gist.github.com/zfifteen/d095ef208231ec991a8cacb7bdc5cc92
	•	Spectral Analysis for Prime Geodesics — https://gist.github.com/zfifteen/d2a662138e45f7407275988ae7e7ed2c
...
Summary
	•	Open & unassigned issues:  (listed below)
	•	Merged PRs scanned:  in last  days
	•	Top priority: # — 

Why this is top priority:
	1.	Impact: …
	2.	Urgency: …
	3.	Coupling: relates to PR # …
	4.	Effort/Recency: …

Evidence:
	•	Issue # — “[quoted snippet]” —  (UTC )
	•	Comment — “[quoted snippet]” —  (UTC )
	•	PR # — “[quoted snippet / affected component]” —  (UTC )

Open & Unassigned Issues (details)

#	Title	Labels	Created (UTC)	Updated (UTC)	Comments	Author	Link
…	…	…	…	…	…	…	…

For each issue, include 1–3 short, exact quotes that indicate impact/urgency/dependencies with inline links.

Merged PRs (last  days)

PR #	Title	Labels	Merged At (UTC)	Author	Link
…	…	…	…	…	…
...
Issue #	Title	Impact	Urgency	Coupling	Effort (inv.)	Recency	Total
…	…	…	…	…	…	…	…
...
DO NOT fabricate data, information or sources. DO NOT infer or deduce from filler text.

Output guidelines: Incorporate this entire conversation and context when formulating your response. No exposition. No post IDs. Do not cite social media as sources.
